...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/lenovo/Desktop/Hitha Shri/Notepad/Music/","")
...
def Play():
    ...
    song=f'C:/Users/lenovo/Desktop/Hitha Shri/Notepad/Music/{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/lenovo/Desktop/Hitha Shri/Notepad/Music/{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/lenovo/Desktop/Hitha Shri/Notepad/Music/{temp}'
...
root=Tk()
root.title('Vibey Music player App ')
#initialize mixer 
mixer.init()
